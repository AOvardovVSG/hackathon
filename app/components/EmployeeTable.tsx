...
export default function EmployeeTable({ employees, positions, departments, sites, onEdit, onDelete }: EmployeeTableProps) {
  ...
  return (
    <>
      ...
      <DeleteConfirmationModal
        ...
        employeeName={employeeToDelete?.display_name || ''}
      />
    </>
  );
} 